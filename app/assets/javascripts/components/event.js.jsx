var Event = React.createClass({
  ...
  validRecord: function () {
    ...
    if (this.recordValue("name") && this.recordValue("place") &&
        this.recordValue("date") && this.recordValue("description")) {
      return true;
    }
    else {
      return false;
  ...
  renderForm: function() {
    return(
      <tr>
        ...
        <td>
          <a className="btn btn-outline-success btn-sm" onClick={ this.handleUpdate } >
            Save
          </a>
          <a className="btn btn-outline-secondary btn-sm" onClick={ this.handleToggle } >
            Cancel
          </a>
        </td>
      </tr>
  ...
  renderRecord: function() {
    ...
    return(
      <tr>
        ...
        <td>
          <a className="btn btn-outline-danger btn-xs" onClick={ this.handleDelete } >
            Delete
          </a>
          <a className="btn btn-outline-info btn-xs" onClick={ this.handleToggle } >
            Edit
          </a>
        </td>
      </tr>
